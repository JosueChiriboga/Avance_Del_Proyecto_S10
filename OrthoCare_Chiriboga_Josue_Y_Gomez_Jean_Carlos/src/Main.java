...
* Actividad: Avance De Proyecto 2
...
public class Main {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    break;
                case 2:
                    mostrarInformacionPaciente(scanner, pacientes);
                    break;
                case 3:
                    modificarInformacionPaciente(scanner, pacientes);
                    break;
                case 4:
                    modificarEstadoControl(scanner, pacientes);
                    break;
                case 5:
                    modificarFechasControl(scanner, pacientes);
                    break;
                case 6:
                    modificarValorPago(scanner, pacientes);
                    break;
                case 7:
                    mostrarValorTotal(scanner, pacientes);
                    break;
                case 8:
                    crearCita(scanner, pacientes, citas, recepcionista);
                    break;
                case 9:
                    asignarPacienteASala(scanner, pacientes, salas);
                    break;
                case 10:
    ...
    public static void mostrarInformacionPaciente(Scanner scanner, ArrayList<Paciente> pacientes) {
    ...
    public static void modificarInformacionPaciente(Scanner scanner, ArrayList<Paciente> pacientes) {
    ...
    public static void modificarEstadoControl(Scanner scanner, ArrayList<Paciente> pacientes) {
    ...
    public static void modificarFechasControl(Scanner scanner, ArrayList<Paciente> pacientes) {
    ...
    public static void modificarValorPago(Scanner scanner, ArrayList<Paciente> pacientes) {
    ...
    public static void mostrarValorTotal(Scanner scanner, ArrayList<Paciente> pacientes) {
    ...
    public static void asignarPacienteASala(Scanner scanner, ArrayList<Paciente> pacientes, ArrayList<Sala> salas) {
